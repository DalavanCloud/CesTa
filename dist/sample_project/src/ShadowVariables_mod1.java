...
public class ShadowVariables { 
	...
	public ShadowVariables(short overriden){
		short i=__set_short((short)(1),(short)0),j=__set_short((short)(2),(short)1),excluded=10;
		if (__get_short(i,(short)0)==__get_short(j,(short)1)){
			i=__set_short((short)(__get_short(i,(short)0)+(__get_short(j,(short)1))),(short)0);
			i=__set_short((short)(__get_short(i,(short)0)+(excluded)),(short)0);
			excluded=__get_short(i,(short)0)+__get_short(j,(short)1);
		}
